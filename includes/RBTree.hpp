...
class rb_tree
{
  ...
  typedef ft::rb_tree_iterator<value_type, node_pointer, difference_type> iterator;
  typedef ft::rb_tree_iterator<value_type, node_pointer, difference_type> const_iterator;
